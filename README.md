...
| 学生端前端 | fun-campus-app（uni-app，登录/首页/详情/支付/收银台/签到码/消息/我的/订单/我的活动/待办/评价） | 🟡 核心页面已实现；部落与资料编辑为占位页，订单列表（含退款申请）、我的活动（三 Tab）、待办事项（含活动评价）入口已通 |
...
- [🟡] 功能入口：我的签到码 / 我的活动 / 我的订单已通；资料编辑为占位入口（"开发中"）
