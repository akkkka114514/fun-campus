    ...
    <view class="flex flex-row flex-row-center-center px-16">
      ...
      >
        ...
        >
          ...
          <tm-text
            v-if="valuedate_start_str"
            :color="focusIndex == 0 ? props.color : 'grey'"
            :label="valuedate_start_str"
          ></tm-text>
        </view>
      </tm-sheet>
      <view class="px-24">
      ...
      >
        ...
        >
          ...
          <tm-text
            v-if="valuedate_end_str"
            :color="focusIndex == 1 ? props.color : 'grey'"
            :label="valuedate_end_str"
          ></tm-text>
        </view>
      </tm-sheet>
    </view>
...
function quickChangeClick(item: quickBtnType) {
  ...
  if (typeof item?.type === "string" && typesar.includes(item?.type)) {
    ...
    if (str == "br") {
      ...
      let dt = DayJs();
      dstr = [
        dt.startOf("week").subtract(1, "day").format(),
        dt.endOf("week").subtract(1, "day").format(),
      ];
    } else if (str == "by") {
      let dt = DayJs();
      ...
      let dt = DayJs();
      dstr = [
        dt.startOf("month").subtract(2, "month").format(),
        dt.endOf("month").format(),
      ];
    } else if (str == "bn") {
      let dt = DayJs();
