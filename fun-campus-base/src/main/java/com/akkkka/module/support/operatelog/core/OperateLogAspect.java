package com.akkkka.module.support.operatelog.core;
...
import com.akkkka.module.support.operatelog.OperateLogDao;
import com.akkkka.module.support.operatelog.annotation.OperateLog;
import com.akkkka.module.support.operatelog.domain.OperateLogEntity;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(annotation.operatelog.support.module.com.akkkka.OperateLog) || @annotation(annotation.operatelog.support.module.com.akkkka.OperateLog)";
