package com.akkkka.gateway.config;
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent>
{
    ...
    private final static String[] EXCLUDE_ROUTES = new String[] { "fun-campus-gateway", "fun-campus-auth", "fun-campus-file", "fun-campus-monitor" };
