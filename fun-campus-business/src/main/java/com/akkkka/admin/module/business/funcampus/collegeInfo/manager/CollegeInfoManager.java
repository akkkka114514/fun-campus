package com.akkkka.admin.module.business.funcampus.collegeInfo.manager;
 ...
 */
@Service
public class CollegeInfoManager extends ServiceImpl<CollegeInfoDao, CollegeInfoEntity> {
